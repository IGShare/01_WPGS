...
linker.cmd: package/cfg/rom_prm3.xdl
	$(SED) 's"^\"\(package/cfg/rom_prm3cfg.cmd\)\"$""\"E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/04_I2C_GMS/i2c_light_sensor/projects/iar_tirtos/configPkg/\1\""' package/cfg/rom_prm3.xdl > $@
