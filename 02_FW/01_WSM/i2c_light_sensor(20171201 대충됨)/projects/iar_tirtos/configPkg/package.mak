...
rom.xrm3: package/cfg/rom_prm3.orm3 
	...
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/04_I2C_GMS/i2c_light_sensor/projects/iar_tirtos/Debug/Exe/i2c_light_sensor_tirtos.out --redirect _Printf=_PrintfFull --redirect _Scanf=_ScanfFull --config_def RTOS_ROM=1 --map E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/04_I2C_GMS/i2c_light_sensor/projects/iar_tirtos/Debug/List/i2c_light_sensor_tirtos.map --config c:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/cc26xxware_2_24_03_17272/linker_files/cc26x0f128.icf -f E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/04_I2C_GMS/i2c_light_sensor/projects/iar_tirtos/configPkg/linker.cmd --semihosting c:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/cc26xxware_2_24_03_17272/driverlib/bin/iar/driverlib.lib --entry __iar_program_start --vfe --silent -o $@ package/cfg/rom_prm3.orm3 -f package/cfg/rom_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
