/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/02_US_TXRX_TEST_SC/adc_data_logger.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2017-02-14 17:01:47.670
...
#define SCIF_ADC_DATA_LOGGER_BUFFER_SIZE 400
...
#define SCIF_ADC_DATA_LOGGER_DIO_O_LED_02 27
...
typedef struct {
    ...
    uint16_t pSamples[400]; ///< ADC sample buffer
    uint16_t tail;          ///< 
