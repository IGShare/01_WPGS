...
C:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/bios_6_46_01_37/packages/iar/targets/arm/ITarget.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/bios_6_46_01_37/packages/iar/targets/arm/ITarget.xs
C:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/bios_6_46_01_37/packages/iar/targets/arm/package.xs:
package.mak: C:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/bios_6_46_01_37/packages/iar/targets/arm/package.xs
...
iar.targets.arm.M3.rootDir ?= C:/PROGRA~2/IARSYS~1/EMBEDD~1.3/arm
iar.targets.arm.packageBase ?= C:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/bios_6_46_01_37/packages/iar/targets/arm/
...
.dlls,rm3 .dlls: rom.prm3

-include package/cfg/rom_prm3.mak
-include package/cfg/rom_prm3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/rom_prm3.dep
endif
rom.prm3: package/cfg/rom_prm3.xdl
	@


ifeq (,$(wildcard .libraries,rm3))
rom.prm3 package/cfg/rom_prm3.c: .libraries,rm3
endif

package/cfg/rom_prm3.c package/cfg/rom_prm3.h package/cfg/rom_prm3.xdl: override _PROG_NAME := rom.xrm3
package/cfg/rom_prm3.c: package/cfg/rom_prm3.cfg
package/cfg/rom_prm3.xdc.inc: package/cfg/rom_prm3.xdl
package/cfg/rom_prm3.xdl package/cfg/rom_prm3.c: .interfaces

clean:: clean,rm3
	-$(RM) package/cfg/rom_prm3.cfg
	-$(RM) package/cfg/rom_prm3.dep
	-$(RM) package/cfg/rom_prm3.c
	-$(RM) package/cfg/rom_prm3.xdc.inc

clean,rm3::
	-$(RM) rom.prm3
.executables,rm3 .executables: rom.xrm3

rom.xrm3: |rom.prm3

-include package/cfg/rom.xrm3.mak
rom.xrm3: package/cfg/rom_prm3.orm3 
	$(RM) $@
	@$(MSG) lnkrm3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/ilinkarm -o E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/06_I2C_GMS_US/i2c_light_sensor/projects/iar_tirtos/Debug/Exe/i2c_light_sensor_tirtos.out --redirect _Printf=_PrintfFull --redirect _Scanf=_ScanfFull --config_def RTOS_ROM=1 --map E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/06_I2C_GMS_US/i2c_light_sensor/projects/iar_tirtos/Debug/List/i2c_light_sensor_tirtos.map --config c:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/cc26xxware_2_24_03_17272/linker_files/cc26x0f128.icf -f E:/igs_svn_data/PROJECT_01/02_FW/01_WSM/06_I2C_GMS_US/i2c_light_sensor/projects/iar_tirtos/configPkg/linker.cmd --semihosting c:/ti/tirtos_cc13xx_cc26xx_2_21_00_06/products/cc26xxware_2_24_03_17272/driverlib/bin/iar/driverlib.lib --entry __iar_program_start --vfe --silent -o $@ package/cfg/rom_prm3.orm3 -f package/cfg/rom_prm3.xdl  --semihosting=iar_breakpoint  --cpu=Cortex-M3 --map $(XDCCFGDIR)/$@.map  --redirect _Printf=_PrintfSmall --redirect _Scanf=_ScanfSmall 
	

rom.test test,rm3 test: rom.xrm3.test

rom.xrm3.test:: rom.xrm3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 rom.xrm3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.rom.xrm3, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
rom_prm3.orm3,copy : package/cfg/rom_prm3.orm3
rom_prm3.srm3,copy : package/cfg/rom_prm3.srm3
