/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     GSM I2C
  * - <b>Project file</b>:     E:/GUI/01_WPGS/02_FW/01_WSM/08_MY_I2C_GMS_00/gms_i2c.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2018-02-19 01:57:05.212
  * - <b>Computer</b>:         DESKTOP-GI5BCAT
  * - <b>User</b>:             myeom
  *
  ...
  *
  *
  * \subsection section_task_desc_i2c I2C
  * No description entered
  *
  */
...
/// I2C: Task ID
#define SCIF_I2C_TASK_ID 0


/// I2C: 
#define SCIF_I2C_AUXIO_I2C_BASE_ADDR 56
/// I2C I/O mapping: LED1
#define SCIF_I2C_DIO_O_LED1 25
/// I2C I/O mapping: I2C SCL
#define SCIF_I2C_DIO_I2C_SCL 6
/// I2C I/O mapping: I2C SDA
#define SCIF_I2C_DIO_I2C_SDA 7
...
/// I2C: Task output data structure
typedef struct {
    int16_t  highX; ///< 
    int16_t  highY; ///< 
    int16_t  highZ; ///< 
...
typedef struct {
    struct {
        SCIF_I2C_OUTPUT_T output;
        SCIF_I2C_STATE_T state;
    } i2c;
} SCIF_TASK_DATA_T;
