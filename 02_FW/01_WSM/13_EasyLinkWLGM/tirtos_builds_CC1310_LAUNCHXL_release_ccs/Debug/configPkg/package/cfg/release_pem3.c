 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = E:/GUI/01_WPGS/02_FW/01_WSM/13_EasyLinkWLGM/tirtos_builds_CC1310_LAUNCHXL_release_ccs/Debug/configPkg/package/cfg/release_pem3");
