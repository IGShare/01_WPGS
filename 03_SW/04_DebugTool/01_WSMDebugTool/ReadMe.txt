================================================================================
    MFC 라이브러리 : 01_WSMDebugTool 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 01_WSMDebugTool 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 01_WSMDebugTool 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

01_WSMDebugTool.vcproj
...
01_WSMDebugTool.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMy01_WSMDebugToolApp 응용 프로그램
    클래스를 선언합니다.

01_WSMDebugTool.cpp
    응용 프로그램 클래스 CMy01_WSMDebugToolApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\01_WSMDebugTool.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다.  이 아이콘은
    주 리소스 파일인 01_WSMDebugTool.rc에 의해 포함됩니다.

res\My01_WSMDebugTool.rc2
...
01_WSMDebugToolDlg.h, 01_WSMDebugToolDlg.cpp - 대화 상자
    이 파일에는 CMy01_WSMDebugToolDlg 클래스가 들어 있습니다.  이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다.  대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 01_WSMDebugTool.rc에 있습니다.

/////////////////////////////////////////////////////////////////////////////

도움말 지원:

hlp\My01_WSMDebugTool.hhp
    도움말 프로젝트 파일입니다. 여기에는 도움말 파일을 .chm 파일로
    컴파일하는 데 필요한 데이터가 들어 있습니다.

hlp\My01_WSMDebugTool.hhc
    도움말 프로젝트의 내용을 보여 줍니다.

hlp\My01_WSMDebugTool.hhk
    도움말 항목의 색인이 들어 있습니다.

hlp\afxcore.htm
    표준 MFC 명령 및 화면 개체에 대한 표준 도움말 항목이 들어
    있습니다. 이 파일에 사용자 지정 도움말 항목을 추가합니다.

makehtmlhelp.bat
    이 파일은 빌드 시스템에서 도움말 파일을 컴파일하는 데 사용됩니다.

hlp\Images\*.gif
    MFC 라이브러리 표준 명령에 대한 표준 도움말 파일 항목에 필요한
    비트맵 파일입니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 01_WSMDebugTool.pch와
